 ...
 */
                    ...
                    var g = a.FB_enumerate
                      , h = function() {
                        ...
                        var b = "key", i = "value", j = "key+value", k = "$map_", l, m = "IE_HASH_", a = function() {
                            ...
                            c.set = function(a, b) {
                                var c = o(this, a);
                                c != null && this._mapData[c] ? this._mapData[c][1] = b : (c = this._mapData.push([a, b]) - 1,
                                p(this, a, c),
                                this.size += 1);
                                return this
                            }
                ...
                __d("sdk.Auth-public", ["FB", "sdk.Auth", "sdk.Auth.LoginStatus", "sdk.AuthUtils", "sdk.Event", "sdk.Runtime", "sdk.ui", "sdk.warnInsecure"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a() {
                        ...
                        c("sdk.Auth").subscribe("logout", ES(d("sdk.Event").fire, "bind", !0, d("sdk.Event"), "auth.logout")),
                        c("sdk.Auth").subscribe("login", ES(d("sdk.Event").fire, "bind", !0, d("sdk.Event"), "auth.login")),
                        c("sdk.Auth").subscribe("authresponse.change", ES(d("sdk.Event").fire, "bind", !0, d("sdk.Event"), "auth.authResponseChange")),
                        c("sdk.Auth").subscribe("status.change", ES(d("sdk.Event").fire, "bind", !0, d("sdk.Event"), "auth.statusChange")),
                        c("sdk.Auth").subscribe("loginDenied", ES(d("sdk.Event").fire, "bind", !0, d("sdk.Event"), "auth.denied")),
                        c("sdk.Auth").subscribe("loginError", ES(d("sdk.Event").fire, "bind", !0, d("sdk.Event"), "auth.error")),
                        c("sdk.Runtime").subscribe("AccessToken.change", function(a) {
                    ...
                    a = function(a) {
                        ...
                        e.$CustomerChat21 = function(a) {
                            ...
                            this.$CustomerChat3 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    d("ChatPluginSDKPreLoggingUtils").preLogging(b.$CustomerChat16, "chat_plugin_sdk_icon_iframe_load", b.params),
                                    b.$CustomerChat2 = j,
                                    b.$CustomerChat26(),
                                    b.$CustomerChat27(),
                                    window.setTimeout(function() {
                        ...
                        e.$CustomerChat27 = function() {
                            this.$CustomerChat2 !== null && this.$CustomerChat7 !== null && this.$CustomerChat9 !== null && this.$CustomerChat5 !== null && this.$CustomerChat11 !== null && !this.$CustomerChat12 && (this.$CustomerChat12 = !0,
                        ...
                        e.$CustomerChat29 = function(a) {
                            ...
                            if (!this.$CustomerChat14) {
                                ...
                                c("sdk.cp.Constants").animationEvents.forEach(function(e) {
                                    var f = function(e) {
                                        b.$CustomerChat14 && (d("sdk.DOM").setStyle(a, "maxHeight", "0"),
                    ...
                    var h = function(b) {
                        ...
                        e.process = function() {
                            ...
                            c("CORSRequest").execute(b, "get", {
                                ...
                                a.$CustomerChatWrapper5.should_use_new_domain = b.should_use_new_domain,
                                a.$CustomerChatWrapper1 = new (c("sdk.XFBML.ChatDOM"))(a.$CustomerChatWrapper2,a.$CustomerChatWrapper3,a.$CustomerChatWrapper4,a.$CustomerChatWrapper5),
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1007321788","namespace":"FB","message":"' + e.message + '"}}');
